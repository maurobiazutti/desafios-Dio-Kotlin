package `3`.` Praticando programação em Kotlin`
/*
Desafio
...
matemática e têm muita dificuldade para resolver as brincadeiras propostas por ela.
...
deve-se somar ambos os dígitos e se os DÍGITOS forem iguais, deve-se desconsiderar a letra e
mostrar o produto entre os dois dígitos. Ela pediu para seu amigo Marcelo, que é bom em programação,
...
na segunda posição uma letra maiúscula ou minúscula do alfabeto e na terceira posição outro
caractere de '0' a '9'.
